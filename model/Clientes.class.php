...
Class Clientes extends Conection {
    ...
    public function setClient_email ($client_email) {
        if(filter_var($client_email, FILTER_VALIDATE_EMAIL)) {
            ...
            Routes::redirecionarPagina(1,Routes::pag_de_cadastro());
        }        
    }
    ...
    function SetaDadosValidados (
        $client_email, $client_senha, $client_nome=null, $client_endereco=null, $client_numero=null,
       $client_bairro=null, $client_cidade=null, $client_uf=null, $client_cep=null, $client_telefone=null
    ) {
